...
function work(spotifyApi) {
 ...
 db.each("select distinct artist, music, spotify_id, deezer_id from music where spotify_id is not null and deezer_id is not null", function(err, row) {
...
var options = {
    ...
    qs: {'seed_tracks': row.spotify_id, 'limit': '5', 'min_popularity': '50'},
    headers: {
